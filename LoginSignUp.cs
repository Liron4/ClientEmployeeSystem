...
namespace EmployeeSystemLT
{
    public partial class LoginSignUp : Form
    {
        ...
        public class BasicEmployee : User
        {
        ...
        private void SignUp_Click(object sender, EventArgs e)
        {
            ...
            Customer newUser = new Customer { Username = user, Password = pass, Address = add, PhoneNumber = phone }; // default: customer
        ...
        private void Login_Click(object sender, EventArgs e)
        {
            ...
            User foundUser = DataManager.Users.FirstOrDefault(existingUser => existingUser.Username == user && existingUser.Password == pass);
            ...
            SessionData.LoggedInUser = foundUser; // Set the logged-in user
        ...
        private void LoginSignUp_Load(object sender, EventArgs e)
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                {
                    DataManager.Users = (List<User>)serializer.Deserialize(fs);
                }
            }
            else
            {
        ...
        private void ChangePWApply_Click(object sender, EventArgs e)
        {
            ...
            User foundUser = DataManager.Users.FirstOrDefault(u => u.Username == user && u.Password == oldpass);
        ...
        private void LoginAsAdmin()
        {
            ...
            User adminUser = DataManager.Users.FirstOrDefault(u => u.Username == "admin");
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex == dataGridView1.Columns["Level"].Index)
            {
                ...
                if (!string.IsNullOrEmpty(newLevel) && userTypeMapping.ContainsKey(newLevel))
                {
                    ...
                    User oldUser = (User)dataGridView1.Rows[e.RowIndex].DataBoundItem;
                    Type targetType = userTypeMapping[newLevel];

                    //language activator to create instance copy
                    User newUser = (User)Activator.CreateInstance(targetType);

...
namespace EmployeeSystemLT
{
    ...
    {
   //     public LoginSignUp.User currentClient;
        ...
        private void STAFFAREA_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            OGForm.Welcome_Label.Text = $"Welcome, {SessionData.LoggedInUser.Level}!";
            if (OGForm != null)
            {
                OGForm.Show();
            }
        ...
        private void PopulateShiftsListView()
        {
            ...
            int checklevel = SessionData.LoggedInUser.AccessBox();
            ...
            foreach (ShiftData shift in shiftsList)
            {
                ...
                if (checklevel == 3 || checklevel == 4)
                {
                    ...
                    if (shift.UserName == SessionData.LoggedInUser.Username)
                    {
        ...
        /*    if (selectedDay <= DateTime.Today)
          ...
          /*  if ((selectedDay - DateTime.Today).TotalDays > 7)
            ...
            {
                if (Item.SubItems[0].Text == SessionData.LoggedInUser.Username && DateTime.Parse(Item.SubItems[1].Text).Date == selectedDay)
                {
           ...
           /* if (shiftDuration.TotalHours < 6 || shiftDuration.TotalHours > 11)
            ...
            int userShiftCount = shiftsList.Count(shift => shift.UserName == SessionData.LoggedInUser.Username);
          /* if (userShiftCount >= 5)
            {
            ...
            {
                UserName = SessionData.LoggedInUser.Username,
                Day = selectedDay,
...
#pragma warning restore CS8600 // Avoid green text
        ...
        private void CurrentOrdersButton_Click(object sender, EventArgs e)
        {
            ...
            int userAccessLevel = SessionData.LoggedInUser.AccessBox();

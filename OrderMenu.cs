...
namespace EmployeeSystemLT
{
    public partial class OrderMenu : Form
    {
        ...
        {
            if (SessionData.LoggedInUser.AccessBox() >= 2)
            {
        ...
        private void PlaceOrderButton_Click(object sender, EventArgs e)
        {
            ...
            {
                currentOrder.ClientsName = SessionData.LoggedInUser.Username;
                currentOrder.Address = SessionData.LoggedInUser.Address;
                currentOrder.PhoneNumber = SessionData.LoggedInUser.PhoneNumber;
        ...
        private void OrderMenu_FormClosing(object sender, FormClosingEventArgs e)
        {
          ...
          //  StartWindow? OGForm = Application.OpenForms["StartWindow"] as StartWindow;
            ...
            currentClient = SessionData.LoggedInUser;
       ...
       /* if (OGForm != null)
            ...
            SessionData.LoggedInUser = currentClient;
